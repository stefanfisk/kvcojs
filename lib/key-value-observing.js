...
var KeyValueObservingMixin = {
   ...
   */
  didChangeValueForKey: function(key, value) {
   ...
   * @return {Rx.Observable}  The observable.
   */
  observableForKeyPath: function(keyPath) {
      ...
      return this.observableForKey(currentKey)
        .map(function(value) {
          if (undefined === value || null === value) {
            ...
            return Rx.Observable.return(getValueForKeyPath(value, remainingKeys));
          } else {
